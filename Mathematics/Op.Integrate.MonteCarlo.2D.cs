namespace Physics.NET.Mathematics
{
    public static partial class Op
    {
        public static partial class Integrate
        {
            ...
            public static double MonteCarlo(Func<double, double, bool> domain, Func<double, double, double> function, ValueTuple<string, double, double> rangeX, ValueTuple<string, double, double> rangeY, int N)
            {
            ...
            /// <returns>Value of a 2D definite integral.</returns>
            /// <exception cref="ArgumentException"></exception>
            public static double MonteCarlo(Func<double, double, bool> domain, Func<double, double, double> function, ValueTuple<string, double, double> rangeX, ValueTuple<string, double, double> rangeY, int N, int threads)
            {
                if (threads > Environment.ProcessorCount - 2)
                {
                    throw new ArgumentException($"error: {threads} exceeds recommended amount of threads");
                }
            ...
            public static double MonteCarlo(Func<Vector2D<Cartesian>, bool> domain, Func<Vector2D<Cartesian>, double> function, ValueTuple<string, double, double> rangeX, ValueTuple<string, double, double> rangeY, int N)
            {
                if (rangeX.Item2 > rangeX.Item3 || rangeY.Item2 > rangeY.Item3)
                {
                    throw new ArgumentException("error: invalid bounds");

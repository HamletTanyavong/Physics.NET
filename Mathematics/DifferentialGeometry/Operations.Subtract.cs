...
namespace Physics.NET.Mathematics.DifferentialGeometry
{
    ...
    {
        public static FourVector<T, I> Subtract<T, I>(FourVector<T, I> a, FourVector<T, I> b)
        ...
        public static FourVector<T, I> Subtract<T, I>(FourVector<Cartesian, I> a, FourVector<Cartesian, I> b)
            where T : class, ICoordinateSystem, I3D
            where I : class, IIndexPosition
        {
        ...
        public static FourVector<T, I> Subtract<T, I>(FourVector<Cylindrical, I> a, FourVector<Cylindrical, I> b)
            where T : class, ICoordinateSystem, I3D
            where I : class, IIndexPosition
        {
        ...
        public static FourVector<T, I> Subtract<T, I>(FourVector<Spherical, I> a, FourVector<Spherical, I> b)
            where T : class, ICoordinateSystem, I3D
            where I : class, IIndexPosition
        {
            var r_0 = a.Zeroth - b.Zeroth;

...
namespace Physics.NET.Mathematics.DifferentialGeometry
{
    public static partial class Operations
    {
            ...
            where I : class, IIndexPosition
        {
            ...
            return coordinateSystem switch
            {
                "Cartesian" => Multiply<T, I>((FourVector<Cartesian, I>)a, b),
                "Cylindrical" => Multiply<T, I>((FourVector<Cylindrical, I>)a, b),
                "Spherical" => Multiply<T, I>((FourVector<Spherical, I>)a, b),
        ...
        public static FourVector<T, I> Multiply<T, I>(FourVector<Cartesian, I> a, double b)
            where T : class, ICoordinateSystem, I3D
            where I : class, IIndexPosition
        {
            return new(b * a.Zeroth, b * a.First, b * a.Second, b * a.Third);
        }
        ...
        public static FourVector<T, I> Multiply<T, I>(FourVector<Cylindrical, I> a, double b)
            where T : class, ICoordinateSystem, I3D
            where I : class, IIndexPosition
        {
            var r_0 = b * a.Zeroth;
        ...
        public static FourVector<T, I> Multiply<T, I>(FourVector<Spherical, I> a, double b)
            where T : class, ICoordinateSystem, I3D
            where I : class, IIndexPosition
        {
            var r_0 = b * a.Zeroth;

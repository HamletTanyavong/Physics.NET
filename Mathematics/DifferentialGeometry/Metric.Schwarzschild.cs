namespace Physics.NET.Mathematics.DifferentialGeometry
{
    ...
    {
        /// <summary>
        /// Calculate the value of the Schwarzschild metric for an object of mass <paramref name="M"/> at a point in spacetime represented by a <paramref name="fourvector"/>. Takes in a four-vector with a contravariant index. Coordinates must be spherical.
        /// </summary>
        ...
        /// <summary>
        /// Calculate the value of the inverse Schwarzschild metric for an object of mass <paramref name="M"/> at a point in spacetime represented by a <paramref name="fourvector"/>. Takes in a four-vector with a covariant index. Coordinates must be spherical.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="M"></param>
        /// <param name="fourvector"></param>

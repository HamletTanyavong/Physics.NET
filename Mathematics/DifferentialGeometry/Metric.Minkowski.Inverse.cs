namespace Physics.NET.Mathematics.DifferentialGeometry
{
    public static partial class Metric
    {
            ...
            where T : class, ICoordinateSystem, I3D
        {
            ...
            {
                "Cartesian" => Minkowski<T>(Session.Signature, (FourVector<Cartesian, L>)fourvector),
                "Cylindrical" => Minkowski<T>(Session.Signature, (FourVector<Cylindrical, L>)fourvector),
                "Spherical" => Minkowski<T>(Session.Signature, (FourVector<Spherical, L>)fourvector),
        ...
        public static FourVector<T, U> Minkowski<T>(Signature<Spacelike> _, FourVector<Cylindrical, L> fourvector)
            where T : class, ICoordinateSystem, I3D
        {
            return new FourVector<T, U>(-1, 1, 1 / (fourvector.First * fourvector.First), 1);
        }

...
namespace Physics.NET.Mathematics.Helper
{
    ...
    {
        internal static FourVector<T, I> Coordinate<T, I>(MetricMethod<T, I> method, string operation, FourVector<T, I> a)
            ...
            where I : class, IIndexPosition
        {
            ...
            {
                "Cartesian" => method("Cartesian", operation, a),
                "Cylindrical" => method("Cylindrical", operation, a),
                "Spherical" => method("Spherical", operation, a),
                _ => throw new TypeAccessException($"{coordinateSystem} is not a valid coordinate system"),
            };
        }

        internal delegate FourVector<T, I> MetricMethod<T, I>(string coordinate, string operation, FourVector<T, I> a)
            where T : class, ICoordinateSystem, I3D
            where I : class, IIndexPosition;

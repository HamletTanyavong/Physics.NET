...
namespace Physics.Math
{
    ...
    public static class Integrate
    {
        ...
        /// </summary>
        /// <remarks>
        /// <para>This method utilizes parallel computing to quicken integration but may use more system memory. Efficiency will vary based on different processors.</para>
        /// </remarks>
